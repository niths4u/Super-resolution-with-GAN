...
if __name__ == '__main__':
    ...
    #C:\data_science_tasks\notebooks\masters\code1\Text-Image-Super-Resolution-Reconstruction-master\RELEASE_2015-08-31\DATA\TRAIN
    train_datalocation = os.path.join('C:', os.sep, 'data_science_tasks', 'notebooks','masters','code1','Text-Image-Super-Resolution-Reconstruction-master','RELEASE_2015-08-31','DATA','TRAIN','HD')
    val_datalocation = os.path.join('C:', os.sep, 'data_science_tasks', 'notebooks','masters','code1','Text-Image-Super-Resolution-Reconstruction-master','RELEASE_2015-08-31','DATA','VAL','HD')
